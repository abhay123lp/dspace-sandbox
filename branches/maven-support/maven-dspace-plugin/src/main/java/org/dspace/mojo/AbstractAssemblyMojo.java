 ...
 * @version $Id: AbstractAssemblyMojo.java 489631 2006-12-22 12:02:32Z kenney $
 */
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        try
        {
            ...
            assemblies = Collections.singletonList(
                    assemblyReader.readAssembly( 
                            new InputStreamReader(this.getClass().getResourceAsStream("assembly.xml")),
                            "locationDescription", this));
        }
